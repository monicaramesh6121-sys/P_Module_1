...
#Short description:
#A Secret Agent Name Badge that displays a made-up agent ID card on screen, built using your own real name 
#and their favorite gadget. The badge combines a code name, an agent number, a speed rating, and an active status into one final message.
