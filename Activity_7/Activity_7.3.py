...
# Today's lesson was a set of challenges — operator precedence, divisibility with %, correcting a mean, and comparing one value against three others. Four separate skills. In this assignment you use all four in one program, on one family's shopping. Each part answers a different question about the same grocery bill, 
# and the last part puts the answers side by side.
