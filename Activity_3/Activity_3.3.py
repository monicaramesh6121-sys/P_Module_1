...
#In this assignment, you will build a Classroom Points Calculator using Python. You will store team points, calculate total and average points, 
# pack reward stars into boxes, compare scores with last week, and update totals using assignment operators.
