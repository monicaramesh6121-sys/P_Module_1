...
# In this assignment, you will build a Daily Activity Planner using Python. 
# You will use indentation, conditional statements, if statements, and if-else statements to suggest daily activities based on temperature, rain, homework time, and free time.
