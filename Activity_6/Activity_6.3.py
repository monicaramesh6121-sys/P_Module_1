# tudent App Access Manager
# In this assignment, you will build a Student App Access Manager using Python. You will check whether entered values have expected data types, verify whether an app belongs to approved or restricted lists, represent app permissions with binary values, combine and test permissions using bitwise operators, and demonstrate left and right bit shifts.
